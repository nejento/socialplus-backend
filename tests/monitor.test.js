...
const mockInfluxDBService = {
    queryMetrics: globals_1.jest.fn(),
    queryPostMetrics: globals_1.jest.fn()
};
const mockPerformanceMonitorService = {
    getPerformanceSummary: globals_1.jest.fn(),
    getPerformanceTrends: globals_1.jest.fn(),
    collectMetricsForAllNetworks: globals_1.jest.fn()
};
...
globals_1.jest.mock('../src/social/InfluxDBService', () => ({
    InfluxDBService: {
        getInstance: globals_1.jest.fn().mockReturnValue(mockInfluxDBService)
    }
}));
// Mock PerformanceMonitorService
globals_1.jest.mock('../src/social/PerformanceMonitorService', () => ({
    PerformanceMonitorService: {
        getInstance: globals_1.jest.fn().mockReturnValue(mockPerformanceMonitorService)
    }
}));
// Mock data
const mockUsers = {
    ...
    describe('Metrics Collection Logic', () => {
        ...
        it('should handle metrics collection errors', async () => {
            ...
            try {
                ...
                expect(error.message).toBe('Collection failed');
            }
        });
    });
